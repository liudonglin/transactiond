...
type NotifyUnitMessage struct {
	GroupId              string           `protobuf:"bytes,1,opt,name=groupId,proto3" json:"groupId,omitempty"`
	UnitId               string           `protobuf:"bytes,2,opt,name=unitId,proto3" json:"unitId,omitempty"`
	State                TransactionState `protobuf:"varint,3,opt,name=state,proto3,enum=txmsg.TransactionState" json:"state,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *NotifyUnitMessage) GetUnitId() string {
	if m != nil {
		return m.UnitId
	}
	return ""
...
var fileDescriptor_a49baf2e5143a5e0 = []byte{
	...
	,
}
